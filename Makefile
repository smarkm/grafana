...
build-o-env: ## build docker env for specific os release base on dockerfile
	docker build -t dockergrafana -f ./MyDockerfile .
## sample: docker run --rm -v /repo/grafana/grafana:/grafana -it dockergrafana /bin/sh
