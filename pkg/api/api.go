...
func (hs *HTTPServer) registerRoutes() {
	...
	r.Post("/api/user-relationship/save", reqGrafanaAdmin, bind(models.UserRelationship{}), Wrap(hs.SaveUserRelationshipHandler))
	r.Put("/api/user-relationship/update", reqGrafanaAdmin, bind(models.UserRelationship{}), Wrap(hs.UpdateUserRelationshipHandler))
